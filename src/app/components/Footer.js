...
export default function Footer() {
    return (
        <div className="bg-[#2B395D] w-full h-full md:h-[45vh] px-15 pt-10 flex flex-col overflow-hidden relative font-mono"> {/* Added 'flex flex-col' */}
            <div className="flex flex-col md:flex-row justify-between flex-grow"> {/* Added 'flex-grow' */}
                <div className="hidden md:flex flex-col justify-between p-5">
                ...
                <div className="flex flex-col justify-center gap-10 md:flex-row md:justify-start items-start md:gap-20 text-white text-xl md:pr-[10%] pt-2 uppercase">
                    ...
                    <div className="flex flex-col gap-5 md:gap-10">
                        <p className="font-semibold underline md:no-underline md:ml-10">Navigation</p>
            ...
            <div className="hidden absolute bottom-10 right-0 w-[50%] md:flex justify-end pr-[10%]"> {/* Changed width and justify */}
                <p className="text-white text-6xl font-bold">CONTACT</p>
            </div>
            <div className="flex md:hidden flex-col justify-center items-center py-20">
