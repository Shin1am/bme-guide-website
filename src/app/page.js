      ...
      <main className="w-full p-8 sm:p-20">
        ...
        <div className="flex flex-col justify-center min-h-[40vh] lg:min-h-[60vh] border-b-2 border-b-[#bfb9b0]">
          ...
          <div className="flex flex-col items-center md:items-start justify-center gap-6">
            <h1 className="text-[clamp(1.875rem,5vw,3.75rem)] w-full md:w-3/4 lg:w-1/2 font-bold px-8 transition-all duration-300">
            ...
            <h2 className="text-[#292625] text-xl text-center md:text-left md:text-3xl lg:text-4xl font-bold px-8 transition-all duration-300">
              Your journey to becoming a better Biomedical Engineer starts here!
            </h2>
          </div>

          <div className='px-8 hidden md:flex flex-row gap-6 mt-25 text-center items-center justify-center'>
            <Link className='text-base bg-white rounded-3xl shadow-lg md:text-xl lg:text-3xl md:w-[20%] h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/learning">Learning</Link>
            <Link className='text-base bg-white rounded-3xl shadow-lg md:text-xl lg:text-3xl md:w-[20%] h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/map">Map</Link>
            <Link className='text-base bg-white rounded-3xl shadow-lg md:text-xl lg:text-3xl md:w-[20%] h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/lab">Lab</Link>
            <Link className='text-base bg-white rounded-3xl shadow-lg md:text-xl lg:text-3xl md:w-[20%] h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/more">More</Link>
            <Link className='text-base bg-white rounded-3xl shadow-lg md:text-xl lg:text-3xl md:w-[20%] h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/about-us">About Us</Link>
          </div>

          <div className='px-8 grid grid-cols-2 grid-rows-3 md:hidden gap-6 mt-15 mb-10 text-center items-center justify-center'>
            <Link className='text-base bg-white rounded-3xl shadow-lg h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/learning">Learning</Link>
            <Link className='text-base bg-white rounded-3xl shadow-lg h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/map">Map</Link>
            <Link className='text-base bg-white rounded-3xl shadow-lg h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/lab">Lab</Link>
            <Link className='text-base bg-white rounded-3xl shadow-lg h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/more">More</Link>
            <Link className='text-base bg-white rounded-3xl shadow-lg h-auto p-4 hover:shadow-[0_6px_20px_rgba(56,125,255,0.17)] hover:scale-110 transition-all duration-300' href="/about-us">About Us</Link>
          </div>
        </div>
        ...
        <div className="p-8">
          <div className="flex flex-col justify-center items-center p-10">
            <p className="text-5xl lg:text-[80px]">Roadmap</p>
            <p className="text-4xl lg:text-[56px] lg:-mt-5">Journey</p>
          </div>
          <div className="-mt-20 md:mt-0 md:p-20">
            <div className="flex flex-col scale-85 md:scale-100 lg:flex-row">
              <div className="flex flex-col items-center scale-75 md:scale-100 hover:scale-110 transition-all duration-300">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-55 w-55 rotate-90 scale-80 md:hidden" viewBox="0 0 100 100" stroke="#B6AFA6" strokeWidth={9}>
                  <line x1={20} y1={50} x2={80} y2={50} />
                </svg>
              </div>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-55 w-55 hidden md:flex" viewBox="0 0 100 100" stroke="#B6AFA6" strokeWidth={9}>
                <line x1={20} y1={50} x2={80} y2={50} />
              </svg>
        ...
        <div className = "flex flex-col md:flex-row gap-6 w-full h-auto p-2 md:p-6 mt-15">
          <div className="flex flex-col gap-8 w-full bg-white p-8 rounded-3xl shadow-2xl justify-center items-center">
            <h2 className="text-center md:text-left text-xl md:text-3xl font-bold text-gray-800 mb-4">Mahidol Website, contact list</h2>
          ...
          <div className="flex flex-col gap-8 w-full rounded-3xl bg-white shadow-2xl p-4 md:p-0 justify-center items-center">
            <h2 className="text-center md:text-left text-xl md:text-3xl font-bold text-gray-800 p-2 md:p-0 md:mb-4">Engineering Website, contact list</h2>
            <div className="flex flex-col gap-6 items-start">
